...
steps = 150
x.points = seq(-3.5, -2, length.out=steps) #range(X[,2]) # 0.8386535 0.9095565
y.points = seq(-0.5, 1.5, length.out=steps) #range(X[,3]) # 0.007071446 0.044158466
...
save(cl, mm,  file='data/coda_skew_t_mixture_b.RData')
