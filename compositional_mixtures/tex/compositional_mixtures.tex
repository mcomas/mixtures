...
The components of vector $h(\textbf{x})=(h_1, \dots, h_{D-1})$ are the orthonormal log-ratio coordinates of $\textbf{x}$ respect $\mathcal{B}$.\footnote{An example of orthonormal log-ratio coordinates  \citep{egozcue2003isometric} is given by
\begin{equation}
\label{eilr}
h_i=\sqrt{\frac{i}{i+1}}\,\ln\frac{\sqrt[i]
{\prod_{j=1}^{i} x_j}}{x_{i+1}},\,i=1,\dots,D-1.
\end{equation}
which is are the orthonormal log-ratio coordinates of $\textbf{x}$ respect 
\[
