...
%\rhead{Compositional mixture models}
...
%\subtitle{Running headline: Compositional mixture models}
...
\bibitem[Albert \& Gupta, 1982]{albert1982mixtures}
Albert, J.~H.    \& Gupta, A.~K. (1982).
\newblock {Mixtures of Dirichlet distributions and estimation in contingency tables}.
\newblock {\em Ann. Statist.}, \textbf{10(4)}, 1261--1268.

\bibitem[Andrews \& McNicholas, 2012]{andrews2012model}
Andrews, J.~L. \& McNicholas, P.~D. (2012).
\newblock {Model-based clustering, classification, and discriminant analysis via mixtures of multivariate t-distributions: The tEIGEN family}.
\newblock {\em Stat. Comput.}, \textbf{22}, 1021--1029.

\bibitem[Bache \& Lichman, 2013]{uci2013repository}
Bache, K. \& Lichman, M. (2013).
\newblock {UCI machine learning repository}. 
\newblock [http://archive.ics.uci.edu/ml]. Irvine, CA: University of California, School of Information and Computer Science.
 
\bibitem[Azzalini, 1985]{azzalini1985class}
Azzalini, A. (1985)
\newblock {A class of distributions which includes the normal ones}.
\newblock {\em Scand. J. Statist.}, \textbf{12}, 171--178.


\bibitem[Azzalini \& Capitanio, 1999]{azzalini1999statistical}
Azzalini, A. \& Capitanio, A. (1999).
\newblock {Statistical applications of the multivariate skew normal distribution}.
\newblock {\em J. R. Stat. Soc. Ser. B Stat. Methodol}, \textbf{61(3)}, 579--602.
...
\newblock {\em J. Mach. Learn. Res.}, \textbf{6},1345--1382.

\bibitem[Barcel\'{o}-Vidal et~al., 1999]{barcelo1999comment}
Barcel\'{o}-Vidal, C., Mart\'{\i}n-Fern\'{a}ndez, J.~A., \& Pawlowsky-Glahn, V. (1999).
\newblock {Comment on ``Singularity and nonnormality in the classification of compositional data'' by Bohling, G. C., Davis, J. C., Olea, R. A. \& Harff, J.}
\newblock {\em Mathematical Geology}, \textbf{31(5)}, 581--585.

\bibitem[Bickel \& Scheffer, 2004]{bickel2004multi}
Bickel, S. \& Scheffer, T. (2004).
\newblock {Multi-view clustering}.
\newblock In Rastogi, R., Morik, K., Bramer, M., \& Wu, X., editors, {\em ICDM 2004, fourth IEEE International Conference on Data Mining}, 19--26, Brighton. IEEE Computer Society.

\bibitem[Bouguila, 2011]{bouguila2011count}
Bouguila, N. (2011).
\newblock {Count data modeling and classification using finite mixtures of distributions}.
\newblock {\em IEEE Transactions on Neural Networks}, \textbf{22}, 186--198.

\bibitem[Bouguila et~al., 2004]{bouguila2004unsupervised}
Bouguila, N., Ziou, D. \& Vaillancourt, J. (2004).
\newblock {Unsupervised learning of a finite mixture model based on the Dirichlet distribution and its application}.
\newblock {\em IEEE Transactions on Image Processing}, \textbf{13}, 1533--1543.

\bibitem[Browne \& McNicholas, 2013]{browne2013mixture}
Browne, R.~P. \& McNicholas, P.~D. (2013).
\newblock {A mixture of generalized hyperbolic distributions}.
\newblock {ArXiv e-prints} arXiv:1305.1036

\bibitem[Buccianti, 2011]{buccianti2011natural}
Buccianti, A. (2011).
\newblock {\em {Natural laws governing the distribution of the elements in geochemistry: the role of the log-ratio approach}}, 255--266.
\newblock John Wiley \& Sons, Ltd.

\bibitem[Celeux \& Govaert, 1992]{celeux1992classification}
Celeux, G. \& Govaert, G. (1992).
\newblock {A classification EM algorithm for clustering and two stochastic versions}.
\newblock {\em Comput. Statist. Data Anal.}, \textbf{14(3)}, 315--332.

\bibitem[Connor \& Mosimann, 1969]{connor1969concepts}
Connor, R.~J. \& Mosimann, J.~E. (1969).
\newblock {Concepts of independence for proportions with a generalization of the Dirichlet Distribution}.
\newblock {\em J. Amer. Statist. Assoc.}, \textbf{64}, 194--206.

\bibitem[Dempster et~al., 1977]{dempster1977maximum}
Dempster, A.~P., Laird, N.~M., \& Rubin, D.~B. (1977).
\newblock {Maximum likelihood from incomplete data via the EM algorithm}.
\newblock {\em J. R. Stat. Soc. Ser. B Stat. Methodol.}, \textbf{39}, 1--38.

\bibitem[Egozcue et~al., 2003]{egozcue2003isometric}
Egozcue, J.~J., Pawlowsky-Glahn, V., Mateu-Figueras, G., \& Barcel\'{o}-Vidal, C. (2003).
\newblock {Isometric logratio transformations for compositional data analysis}.
\newblock {\em Mathematical Geology}, \textbf{35}, 279--300.

\bibitem[Hansen, 1982]{hansen1982large}
Hansen, L.~P. (1982).
\newblock {Large sample properties of generalized method of moments
  estimators}.
\newblock {\em Econometrica}, \textbf{50}, 1029--1054.

\bibitem[Lee \& McLachlan, 2011]{lee2011fitting}
Lee, S.~X. \& McLachlan, G.~J. (2011).
\newblock {On the fitting of mixtures of multivariate skew t-distributions via the EM algorithm}.
\newblock {ArXiv e-prints} arXiv:1109.4706

\bibitem[Lee \& McLachlan, 2014]{lee2013finite}
Lee, S.~X. \& McLachlan, G.~J. (2014).
\newblock {Finite mixtures of multivariate skew t-distributions: some recent and new results}.
\newblock {\em Stat. Comput.}, \textbf{24(2)}, 181--202.

\bibitem[Lin, 2010]{lin2010robust}
Lin, T.~I. (2010).
\newblock {Robust mixture modeling using multivariate skew t distributions}.
\newblock {\em Stat. Comput.}, \textbf{20(3)}, 343--356.

\bibitem[Mardia et~al., 2007]{mardia2007protein}
Mardia, K.~V., Taylor, C.~C. \& Subramaniam, G.~K. (2007).
\newblock {Protein bioinformatics and mixtures of bivariate von Mises distributions for angular data}.
\newblock {\em Biometrics}, 63.

\bibitem[Mateu-Figueras \& Pawlowsky-Glahn, 2007]{mateu2007skew}
Mateu-Figueras, G. \& Pawlowsky-Glahn, V. (2007).
\newblock {The skew-normal distribution on the simplex}.
\newblock {\em Comm. Statist. Theory Methods}, \textbf{36(9)}, 1787--1802.

\bibitem[Mateu-Figueras et~al., 2011]{figueras2011principle}
Mateu-Figueras, G., Pawlowsky-Glahn, V. \& Egozcue, J.~J. (2011).
\newblock {The principle of working on coordinates}.
\newblock In {\em Compositional Data Analysis}, 29--42. John Wiley \&
  Sons, Ltd.

\bibitem[Mateu-Figueras et~al., 2013]{mateu2013normal}
Mateu-Figueras, G., Pawlowsky-Glahn, V. \& Egozcue, J.~J. (2013).
\newblock {The normal distribution in some constrained sample spaces}.
\newblock {\em SORT}, \textbf{37(1)}, 29--56.

\bibitem[McLachlan \& Peel, 2000]{mclachlan2000finite}
McLachlan, G.~J. \& Peel, D. (2000).
\newblock {\em {Finite mixture models, Willey series in probability and statistics}}.
\newblock John Wiley \& Sons, New York.

\bibitem[Monti et~al., 2011]{monti2011shifted}
Monti, G.~S., Mateu-Figueras, G., Pawlowsky-Glahn, V., \& Egozcue, J.~J. (2011).
\newblock {The shifted-scaled Dirichlet distribution in the simplex}.
\newblock In Egozcue, J.~J., Tolosana-Delgado, R. \& Ortego, M.~I., editors, {\em CoDaWork 2011, the 4th International Workshop on Compositional Data Analysis}, Sant Feliu de Gu\'{\i}xols. CIMNE.

\bibitem[Narayanan, 1991]{narayanan1991algorithm}
Narayanan, A. (1991).
\newblock {Algorithm AS 266: maximum likelihood estimation of the parameters of the Dirichlet distribution}.
\newblock {\em J. R. Stat. Soc. Ser. C. Appl. Stat.}, \textbf{40(2)}, 365--374.

\bibitem[Ng et~al., 2011]{ng2011dirichlet}
Ng, K.~W., Tian, G.-L. \& Tang, M.-L. (2011).
...
Ongaro, A., Migliorati, S. \& Monti, G.~S. (2008).
\newblock {A new distribution on the simplex containing the Dirichlet family}.
\newblock In Daunis-i Estadella, J. \& Mart\'{\i}n-Fern\'{a}ndez, J.~A., editors, {\em CoDaWork 2008, the 3rd International Workshop on Compositional Data Analysis}, Girona. Universitat de Girona.

\bibitem[Palarea-Albaladejo et~al., 2014]{palarea2014compositional}
Palarea-Albaladejo, J., Mart\'{\i}n-Fern\'{a}ndez, J.~A., \& Buccianti, A. (2014).
\newblock {Compositional methods for estimating elemental concentrations below the limit of detection in practice using R}.
\newblock {\em Journal of Geochemical Exploration}, \textbf{141}, 71--77.

\bibitem[Papageorgiou et~al., 2001]{papageorgiou2001model}
Papageorgiou, I., Baxter, M.~J. \& Cau, M.~A. (2001).
\newblock {Model-based cluster analysis of artefact compositional data}.
\newblock {\em Archaeometry}, 43(4):571--588.

\bibitem[Pawlowsky-Glahn \& Egozcue, 2001]{pawlowsky2001geometric}
Pawlowsky-Glahn, V. \& Egozcue, J.~J. (2001).
\newblock {Geometric approach to statistical analysis on the simplex}.
\newblock {\em Stochastic Environmental Research and Risk Assessment}, \textbf{15(5)}, 384--398.

\bibitem[Prates et~al., 2013]{prates2013mixsmsn}
Prates, M.~O., Lachos, V.~H. \& Cabral, C. R.~B. (2013).
\newblock {mixsmsn: Fitting finite mixture of scale mixture of skew-normal distributions}.
\newblock {\em Journal of Statistical Software}, \textbf{54(12)}.
...
\bibitem[Rayens \& Srinivasan, 1994]{rayens1994dependence}
Rayens, W.~S. \& Srinivasan, C. (1994).
\newblock {Dependence properties of generalized Liouville distributions on the Simplex}.
\newblock {\em J. Amer. Statist. Assoc.}, \textbf{89}, 1465--1470.

\bibitem[Scott \& Symons, 1971]{scott1971clustering}
Scott, A. \& Symons, M. (1971).
\newblock {Clustering methods based on likelihood ratio criteria}.
\newblock {\em Biometrics}, \textbf{27}, 387--397.
...
\newblock {\em Journal of Quality Technology}, \textbf{46(2)}:127--139.
